...
export function registerScreenshotTool(server, deviceRegistry) {
    server.registerTool("screenshot", {
        description: "Capture a device's screen and upload it to storage, returning a presigned URL plus display + coordinate metadata. Target the primary display, a specific display, the whole virtual desktop, or a window. Large frames auto-compress to JPEG. Map a pixel to a real coordinate as originX + pixelX / scale.",
